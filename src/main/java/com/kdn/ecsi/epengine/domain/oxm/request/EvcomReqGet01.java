 ...
 */
@XmlType( name="RequestGET01", propOrder = { "hd", "bd" } )
@XmlAccessorType(XmlAccessType.FIELD)
@XmlRootElement(name = "evcom")
public class EvcomReqGet01 {
    ...
    @Getter
    @XmlElement(name = "bd")
    protected EvcomBody bd;

    public EvcomReqGet01() {

    }

    public EvcomReqGet01(EvcomRequestHead hd, EvcomBody bd) {
        this.hd = hd;
        this.bd = bd;
    }
